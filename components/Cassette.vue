  ...
  <div>
    ...
    <div class="linerNotes">
      ...
      <div class="linerNotesSpine">
        <span class="spineTitle">D-<span class="green">C90</span> TFH</span>
      </div>
      <div class="linerNotesMainContent clearfix">
        ...
        <div class="linerNotesMainContentInner">
          ...
          <p>
            ...
            <a href="https://www.facebook.com/instantcameraguy/">facebook</a>
          </p>
        </div>
      </div>
...
.cassetteOuter {
  ...
  width: 20em;
  height: 12em;
  box-shadow: darken($c90grey, 15%) 0 0.6em 0 0,
  ...
  &:before {
    ...
    box-shadow: darken($primary, 10%) $cassetteShadow1 $cassetteShadow2 0
      $cassetteShadow4;
  }
...
.middle {
  ...
  box-shadow: $c90grey 0 0 0 0.5em, darken($c90grey, 20%) 0 -1px 0 0.5em;
}
...
.circle {
  ...
  box-shadow: inset $c90grey 0 0 0 0.2em,
    inset darken($c90grey, 15%) 0 0.1em 0 0.2em, inset $cream 0 0.1em 0 0.4em,
...
.teeth {
  ...
  margin-left: -0.85em;
  height: 0.2em;
  box-shadow: inset $cream 0.25em 0 0 0, inset darken($cream, 25%) 0.3em 0 0 0,
    inset $cream -0.25em 0 0 0, inset darken($cream, 25%) -0.3em 0 0 0;
...
.window {
  ...
  border-top: darken($c90grey, 10%) solid 0.1em;
  border-bottom: lighten($c90grey, 15%) solid 0.1em;
  box-shadow: inset darken($c90grey, 15%) 0 0.2em 0 0, $c90grey 0 0 0 0.25em,
...
.bottomHoles {
  ...
  height: 0.6em;
  background: darken($c90grey, 35%);
  box-shadow: inset $brown 0 0.3em 0 0, inset darken($c90grey, 25%) 0 -0.1em 0 0;
  ...
  &.two {
    ...
    &:before {
      ...
      height: 0.4em;
      background: darken($c90grey, 35%);
      box-shadow: inset $brown 0 0.2em 0 0,
...
.linerNotesSpine {
  ...
  font-weight: $bold;
  line-height: 1em;
  box-shadow: inset darken($paper, 25%) 0 0.3em 0 0,
    inset darken($paper, 25%) 0 -0.3em 0 0, inset $c90red 0 -0.7em 0 0,
...
.linerNotesBottom {
  ...
  height: 12em;
  background: $paper;
  box-shadow: inset $c90red 0 1.5em 0 0, inset $c90red 0 -1.5em 0 0,
    inset $red 0 3em 0 0, inset $red 0 -3em 0 0, inset $black 0 4.5em 0 0,
    inset $black 0 -4.5em 0 0, darken($primary, 10%) 1em -1em 0 0;
  padding-top: 1.5em;
  text-align: center;
